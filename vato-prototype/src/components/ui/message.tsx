      ...
      citations.forEach((citation, index) => {
        ...
        const citationBadge = (
          <button
            ...
            className="inline-flex items-center justify-center min-w-[20px] h-5 px-1 mx-1 text-xs font-medium rounded-sm cursor-pointer hover:opacity-80 transition-opacity"
            style={{
